...
const Materials = () => {
    ...
    const handleClickUpdate = (data: any) => {
        navigate(`update-material/${data.id}`);
    }
    const handleClickNewColor = () => {
        navigate(`update-material`)
    }
    useEffect(() => {
        Axios.get('material/get-list-material')
            .then((res) => {
                const listMaterial = res.data;
                    ...
                    <Table aria-label="simple-label">
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell>
                                    <Button variant="outlined" onClick={handleClickNewColor}>New material</Button>
                                </TableCell>
                            </TableRow>
                            <TableRow>
                                <TableCell sx={{ width: '5%', textAlign: 'center' }}>Number</TableCell>
                                <TableCell sx={{ width: '75%', textAlign: 'center' }}>Material</TableCell>
