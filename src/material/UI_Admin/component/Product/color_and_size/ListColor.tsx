                    ...
                    <Table aria-label="simple-label">
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell>
                                    <Button variant="outlined" onClick={handleClickNewColor}>NEW Color</Button>
                                </TableCell>
                            </TableRow>
                            <TableRow>
                                <TableCell sx={{ width: '5%', textAlign: 'center' }}>Number</TableCell>
                                <TableCell sx={{ width: '75%', textAlign: 'center' }}>Color</TableCell>
